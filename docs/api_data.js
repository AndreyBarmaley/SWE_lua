define({ "api": [
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "usage",
        "content": "local buf = SWE.BinaryBuf(\"0123456789\")\n-- C style offset\nbuf:SetByte(0, 0x31, 0x32, 0x33)",
        "type": "json"
      }
    ],
    "version": "0.0.0",
  ...
  {
    "type": "return network supported",
    "url": "SWE.StreamNet.IsSupported()",
    "title": "SWE.StreamNet.IsSupported",
    "group": "SWE.StreamNet",
    "name": "IsSupported",
    "success": {
      "fields": {
        "Return": [
          {
            ...
            "optional": false,
            "field": "result",
            "description": "<p>true if supported</p>"
          }
        ]
      }
    },
  ...
  },
  {
    ...
    "version": "0.0.0",
    "filename": "./api/apidoc_terminal.js",
    "groupTitle": "SWE.Terminal.Window"
  },
  {
  ...
  },
  {
    ...
    "title": "SWE.Terminal.SetTermSize",
    "group": "SWE.Terminal",
    "name": "SetTermSize",
    "parameter": {
      "fields": {
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "usage",
        "content": "local ucs = SWE.UnicodeString(\"123456\")\n-- C style offset\nlocal byte1 = ucs:GetChar(0)\n-- Lua style offset\nlocal byte2 = ucs[1]\nif byte1 == byte2 then\n    print(\"equals\")\nend",
        "type": "json"
      }
    ],
    "version": "0.0.0",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "params",
            "description": "<p>params: { &quot;title&quot;:string, &quot;width&quot;:int, &quot;height&quot;:int, &quot;window&quot;:size, &quot;render&quot;:size, &quot;fullscreen&quot;:bool, &quot;accel&quot;:bool, &quot;resized&quot;:bool }</p>"
          }
        ]
      }
    },
  ...
  },
  {
    ...
    "url": "SWE.TerminalInit(title,frs,cols,rows)(table)",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "params",
            "description": "<p>params: { &quot;title&quot;:string, &quot;cols&quot;:int, &quot;rows&quot;:int, &quot;fontrender&quot;:swe_fontrender, &quot;fullscreen&quot;:bool, &quot;accel&quot;:bool, &quot;resized&quot;:bool }</p>"
          }
        ]
      }
    },

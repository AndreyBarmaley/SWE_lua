define({ "api": [
  ...
  },
  {
    ...
    "url": "SWE.Window.RenderTexture(self,texture,srcx,srcy,srcw,srch,dstx,dsty,flip)(self,texture,src_rt,dst_pt,flip)(self,texture,dstx,dsty,flip)(self,texture,dst_pt,flip)",
  ...
  {
    "type": "window event: system render event",
